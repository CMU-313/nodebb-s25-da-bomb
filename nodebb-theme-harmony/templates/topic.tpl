				...
				<h1 component="post/header" class="tracking-tight fw-semibold fs-3 mb-0 text-break d-flex justify-content-between align-items-center">
					...
					<div class="search">
						<div class="input-group">
							<input class="form-control form-control-sm" id="search-discussion" type="text" placeholder="Search" />
							<button class="btn btn-primary btn-sm" type="button" aria-label="Search">
